...
##create the plot and save it to PNG 480x480 (default) file#
png("plot4.png", width = 480, height=480, type="window")
par(mfrow=c(2,2))
par(ps=12)
with(datapower,plot(DT, Global_active_power, type = "l", xlab = "",ylab = "Global Active Power"))
with(datapower,plot(DT, Voltage, type = "l", xlab = "datetime",ylab = "Voltage"))
...
with(datapower,plot(DT, Global_reactive_power, type = "l", xlab = "datetime"))
dev.off()
